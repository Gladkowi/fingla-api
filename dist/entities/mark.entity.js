...
], MarkEntity.prototype, "id", void 0);
__decorate([
    typeorm_1.OneToMany(() => event_entity_1.EventEntity, event => event.mark),
...
], MarkEntity.prototype, "name", void 0);
MarkEntity = __decorate([
    typeorm_1.Entity('marks')
], MarkEntity);
